...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    NamedCommands.registerCommand("runShooterIntake", m_robotShooterIntake.runShooterIntake());
    NamedCommands.registerCommand("stopShooterIntake", m_robotShooterIntake.stopShooterIntake());
