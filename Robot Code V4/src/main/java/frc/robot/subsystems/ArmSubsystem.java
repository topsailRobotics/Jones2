...
public class ArmSubsystem extends SubsystemBase {
  ...
  private final CANSparkMax m_rightarm = new CANSparkMax(ArmConstants.kInnerArmCanId, MotorType.kBrushless);
  private final CANSparkMax m_leftarm = new CANSparkMax(ArmConstants.kOuterArmCanId, MotorType.kBrushless);
  
  private PIDController pid;
  
  private double targetPosition = ArmConstants.defaultPosition;
  
private final RelativeEncoder m_innerarmencoder = m_rightarm.getEncoder();
