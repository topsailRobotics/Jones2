...
public final class Constants {
  ...
  public static final class WheelConveyorConstants {
    public static final int kIntakeCanId = 51;
    public static final int kShooterIntakeCanId = 52;
    public static final int kBottomShooterCanId = 53;
    public static final int kTopShooterCanId = 54;
  }
  public static final class ArmConstants {
    public static final int kRightArmCanId = 61;
    public static final int kLeftArmCanId = 62;
    public static final int kP = 1;
    public static final double kI = 0;
    public static final int kD = 0;
    public static final double defaultPosition = 0;
    public static final double lowPosition = 1;
    public static final double mediumPosition = 2;
    public static final double highPosition =-4;
  }
}
