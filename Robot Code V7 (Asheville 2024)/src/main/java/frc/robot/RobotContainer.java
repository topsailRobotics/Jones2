...
import frc.robot.subsystems.ArmSubsystem_Manual;
...
public class RobotContainer {
  ...
  private final ArmSubsystem_Manual m_robotArm = new ArmSubsystem_Manual();
  //private final Command MoveArmToDefault = new MoveArmToPosition(m_robotArm, ArmConstants.defaultPosition);
  //private final Command MoveArmToLow = new MoveArmToPosition(m_robotArm, ArmConstants.lowPosition);
  //private final Command MoveArmToMedium = new MoveArmToPosition(m_robotArm, ArmConstants.mediumPosition);
  //private final Command MoveArmToHigh = new MoveArmToPosition(m_robotArm, ArmConstants.highPosition);
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(m_driverController, XboxController.Button.kB.value)
            //.onTrue(MoveArmToLow);  
            .toggleOnTrue(new RunCommand(
            () -> m_robotArm.armLowCommand(), 
            m_robotArm)); 
            
    new JoystickButton(m_driverController, XboxController.Button.kA.value)
            //.onTrue(MoveArmToMedium);  
            .toggleOnTrue(new RunCommand(
            () -> m_robotArm.armDefaultCommand(), 
            m_robotArm)); 
...
/**
 ...
 public Command getAutonomousCommand() {
    // return m_robotShooter.runShooter();
